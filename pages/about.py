...
def render_latex_as_image(formula, fontsize=12, dpi=300, text_color='white'):
    fig = plt.figure(figsize=(max(len(formula)/20, 1), 0.4))  # Tighter size
    ...
    plt.close(fig)
    return f'<div style="text-align: center; margin: 5px 0;"><img src="data:image/png;base64,{img_str}" style="background-color: transparent; border: none; max-width: 80%; height: auto;"></div>'
